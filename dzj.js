...
# 作者(Author)：朱斌
# 链接(URL)：http://blog.toomey.top/2020/01/01/%e6%89%93%e5%ad%97%e6%9c%ba%e6%95%88%e6%9e%9c/
...
function(a) {
    function b(a) {
        var b = a;
        return b.strings = a.strings || ["Put you string here...", "and Enjoy!"],
        ...
        b.showCursor && j.insertAdjacentElement("afterend", l),
        void 0 !== b.cursorChar && (l.textContent = b.cursorChar),
        Promise.resolve(b)
    }
    function c(a, c) {
